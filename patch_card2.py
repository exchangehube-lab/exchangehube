...
new_card = """                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                      <div className="flex justify-between items-baseline mb-0.5">
                        <div className="flex flex-col min-w-0 pr-2">
                          ...
                          {c.channelUsername && (
                            <span className="text-[10px] text-purple-400 truncate">@{c.channelUsername}</span>
                          )}
                        </div>
                        <span className="text-[10px] text-[#B8C0D0] whitespace-nowrap shrink-0 mt-0.5">{msgTime}</span>
                      </div>
                      <div className="flex items-center justify-between mt-0.5">
                        ...
                        {/* Unread Count Placeholder */}
                        <div className="w-5 h-5 rounded-full bg-purple-600 flex items-center justify-center shrink-0 shadow-lg shadow-purple-600/20">
