...
const timeStringRegex = /<span className="text-\[10px\] text-white\/40 mt-1 mx-1">\{timeString\}<\/span>/;
const newTimeString = `<span className="text-[10px] text-white/40 mt-1 mx-1">{timeString}{msg.edited && ' (Edited)'}</span>`;
